...
3. Run `/setup-jd-solanki-skills` in your agent. It will:
    ...
    - Suggest you install and use third-party skills that I mostly use in my projects. See [`THIRD-PARTY.md`](./skills/setup-jd-solanki-skills/THIRD-PARTY.md) for a list of third-party skills.
